import { Avatar, AvatarImage, AvatarFallback } from "@org/shared"
    ...
    const data = [
        {
          ...
          imageAlt: "Thumbnail",
          badge: "Live",
          avatarImage: "https://unsplash.com/photos/R8bNESnnKR8/download?ixid=M3wxMjA3fDB8MXxzZWFyY2h8MTJ8fHBlcnNvbnxlbnwwfHx8fDE3MjIxMDc4NTl8MA&force=true&w=640",
          avatarAlt: "Avatar",
          avatarFallback: "JD",
              ...
              {data.map((item, index) => (
                <div key={index} className="relative group">
                  ...
                  <div className="flex items-center gap-3 mt-3">
                    ...
                    <div>
                      <h3 className="font-medium tracking-tight line-clamp-1">{item.title}</h3>
